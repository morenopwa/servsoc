...
function sanitizeRecord(r) {
  ...
  return {
    ...
    ageUnit: (r.ageUnit === 'meses' || r.ageUnit === 'días') ? r.ageUnit : 'años',
    diagnosis: s(r.diagnosis, 200),
    country: s(r.country, 80) || 'Perú',
    department: s(r.department, 100),
    province: s(r.province, 100),
    district: s(r.district, 100),
    patient: s(r.patient, 60),
    guardianName: s(r.guardianName, 150),
    guardianPhone: s(r.guardianPhone, 30),
    guardianDni: s(r.guardianDni, 20),
    type: s(r.type, 40),
